/**
 * Enrich remaining entity types (mines, aqueducts, ports) with Wikidata images/descriptions.
 *
 * Usage: npx tsx scripts/enrich-remaining-images.ts
 */
...
const ENTITY_TYPES = ['mine', 'aqueduct', 'port'] as const
