...
// one icon per atlas kind (panel entries generate from the registry)
...
export function MapControls({ showTerritories, onToggleTerritories, mapRef }: MapControlsProps) {
  ...
  > = {
    ...
    IslamicConquests: {
      active: showIslamicConquests,
      loading: islamicConquestsLoading,
      toggle: toggleIslamicConquests,
      icon: Flag,
    },
    Provinces: {
